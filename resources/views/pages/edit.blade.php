...
@section("content")
    <section id='edit-section'>
        ...
        <form action="{{Route('edit_function',$apartment->id)}}"
            method="POST"
            enctype="multipart/form-data" v-on:submit='editValidate' novalidate>
            ...
            <div class="form-complit">
                <div class="form-text">
                    ...
                    <div class="form-text-elem">
                        ...
                        <input type="text" min='4' name="title" id="title" value="{{$apartment->title}}" required>
                    </div>
                    ...
                    <div class="form-text-elem">
                        ...
                        <textarea name="description" min='22' id="description" cols="30" rows="10">{{$apartment->description}}</textarea>
                    </div>
            
                    <div class="form-text-elem">
                        <label for="number_rooms">Numero Camere</label>
                        <input type="number" min='1' name="number_rooms" id="number_rooms" value="{{$apartment->number_rooms}}" required>
                    </div>
            
                    <div class="form-text-elem">
                        <label for="number_toiletes">Numero Bagni</label>
                        <input type="number" min='1' name="number_toiletes" id="number_toiletes" value="{{$apartment->number_toiletes}}" required>
                    </div>
            
                    <div class="form-text-elem">
                        <label for="number_beds">Numero Letti</label>
                        <input type="number" min='1' name="number_beds" id="number_beds" value="{{$apartment->number_beds}}" required>
                    </div>
            
                    <div class="form-text-elem">
                        <label for="area">Area</label>
                        <input type="number" min='1' name="area" id="area" value="{{$apartment->area}}" required>
                    </div>
